...
## Project Structure
    ...
    ├── review_updated_modu_43072  # Django project configurations
...
1. Clone this repo and `cd review_updated_modu_43072`
...
2. Clone this repo and `cd review_updated_modu_43072`
