...
export const modules_okta_callback_url_create = createAsyncThunk(
  "oktaCallBacks/modules_okta_callback_url_create",
  async payload => {
...
export default { modules_okta_callback_url_create, slice: oktaCallBacksSlice }
