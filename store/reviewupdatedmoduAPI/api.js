...
function modules_drive_service_create_folder_create(payload) {
  return reviewupdatedmoduAPI.post(`/modules/drive/service/create/folder/`, payload.data);
}
...
function modules_drive_service_share_file_create(payload) {
  return reviewupdatedmoduAPI.post(`/modules/drive/service/share/file/`, payload.data);
}

function modules_drive_service_upload_file_create(payload) {
  return reviewupdatedmoduAPI.post(`/modules/drive/service/upload/file/`, payload.data);
}
