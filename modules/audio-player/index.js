...
const AudioSlider = ({
  ...
  return <Slider minimumValue={0} maximumValue={100} trackStyle={sliderStyles.track} thumbStyle={sliderStyles.thumb} value={percent} minimumTrackTintColor="#93A8B3" onValueChange={seconds => changeTime(seconds)} />;
};
