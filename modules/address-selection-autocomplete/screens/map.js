...
const Maps = ({
  ...
  return <View style={styles.view}>
      <View style={[autoCompleteStyles.autoCompleteCOntainer, {
      height: inputValue ? "100%" : 50
    }]}>
        <GooglePlacesAutocomplete placeholder={settings.placeholder || "Search..."} minLength={2} autoFocus={false} returnKeyType={"default"} fetchDetails={true} textInputProps={{
      ...
      <MapView initialRegion={defaultOrigin} ref={setMapRef} onPress={onMapPress} style={styles.map} onRegionChangeComplete={region => handleDragOrigin(region)} />

      <View style={styles.markerFixed}>
        <Image style={[styles.marker, settings.markerStyles]} source={{
        uri: settings.markerUrl
      }} />
      </View>
